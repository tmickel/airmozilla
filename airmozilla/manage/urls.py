...
urlpatterns = patterns('',
    ...
    url(r'^users/(?P<id>\d+)$', views.user_edit,
                                name='user_edit'),
    url(r'^users', views.users, name='users'),
    url(r'^groups/(?P<id>\d+)$', views.group_edit,
                                 name='group_edit'),
    url(r'^groups/new$', views.group_new, name='group_new'),
    url(r'^groups', views.groups, name='groups'),
    url(r'^events/request', views.event_request,
                            name='event_request'),
    url(r'^events', views.event_edit, name='event_edit'),
    url(r'^tag_autocomplete', views.tag_autocomplete,
                              name='tag_autocomplete'),
    url(r'^participant_autocomplete', views.participant_autocomplete,
